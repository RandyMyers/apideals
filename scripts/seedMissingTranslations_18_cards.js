...
const cardTranslations = [
  ...
  },
  {
    ...
    fr: 'Vérifié {{time}}',
    pt: 'Verificado {{time}}',
    nl: 'Geverifieerd {{time}}',
    'en-GB': 'Verified {{time}}',
    'en-AU': 'Verified {{time}}',
    'de-AT': 'Verifiziert {{time}}',
  ...
  },
  {
    ...
    fr: '{{days}}j {{hours}}h restantes',
    pt: '{{days}}d {{hours}}h restantes',
    nl: '{{days}}d {{hours}}u over',
    'en-GB': '{{days}}d {{hours}}h left',
    'en-AU': '{{days}}d {{hours}}h left',
    'de-AT': '{{days}}T {{hours}}h übrig',
  ...
  },
  {
    ...
    da: '{{percent}}% succes',
    sv: '{{percent}}% framgång',
    fr: '{{percent}}% de succès',
    pt: '{{percent}}% de sucesso',
    nl: '{{percent}}% succes',
  ...
  },
  {
    ...
    fr: 'Appliquer sur: {{product}}',
    pt: 'Aplicar em: {{product}}',
    nl: 'Toepassen op: {{product}}',
    'en-GB': 'Apply on: {{product}}',
    'en-AU': 'Apply on: {{product}}',
    'de-AT': 'Anwenden auf: {{product}}',
  ...
  },
  {
    ...
    nl: '{{days}} dagen over',
    'en-GB': '{{days}} Days Left',
    'en-AU': '{{days}} Days Left',
    'de-AT': '{{days}} Tage übrig',
  ...
  },
  {
    ...
    da: '{{discount}}% RABAT',
    sv: '{{discount}}% RABATT',
    fr: '{{discount}}% DE RÉDUCTION',
    pt: '{{discount}}% DE DESCONTO',
    nl: '{{discount}}% KORTING',
    'en-GB': '{{discount}}% OFF',
    'en-AU': '{{discount}}% OFF',
    'de-AT': '{{discount}}% RABATT',
