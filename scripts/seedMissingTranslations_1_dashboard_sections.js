...
const translations = [
  ...
  {
    key: 'dashboard.sections.useditems',
    category: 'pages',
    en: 'Used Items',
    ga: 'Míreanna Úsáidte',
    de: 'Verwendete Artikel',
    es: 'Artículos Usados',
    it: 'Articoli Usati',
    no: 'Brukte Elementer',
    fi: 'Käytetyt kohteet',
    da: 'Brugte elementer',
    sv: 'Använda objekt',
    fr: 'Articles utilisés',
    pt: 'Itens usados',
    nl: 'Gebruikte items',
    'en-GB': 'Used Items',
    'en-AU': 'Used Items',
    'de-AT': 'Verwendete Artikel',
    description: 'Dashboard used items section',
    context: 'DashboardPage.js',
  },
  {
    key: 'dashboard.sections.activity',
    category: 'pages',
    en: 'Activity',
    ga: 'Gníomhaíocht',
    de: 'Aktivität',
    ...
    'en-AU': 'Activity',
    'de-AT': 'Aktivität',
    description: 'Dashboard activity section',
    context: 'DashboardPage.js',
  },
  {
    key: 'dashboard.sections.notifications',
    category: 'pages',
    en: 'Notifications',
    ga: 'Fógraí',
    ...
    description: 'Dashboard notifications section',
    context: 'DashboardPage.js',
  },
];
